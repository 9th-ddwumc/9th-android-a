...
class AlbumFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val artist = arguments?.getString("singer")
        val albumImg = arguments?.getInt("coverImg")

        albumBinding.albumTitleTv.text = title
        albumBinding.albumSingerTv.text = artist
        albumBinding.coverImgIv.setImageResource(albumImg!!)
