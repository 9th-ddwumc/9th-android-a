...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val lilacAlbum = Album(
            title = "LILAC",
            singer = "아이유 (IU)",
            coverResId = R.drawable.img_main_album
        )

        binding.homeMainAlbumTitleTv.setText(lilacAlbum.title)
        binding.homeMainAlbumSingerTv.setText(lilacAlbum.singer)
        binding.homeMainAlbumIv.setImageResource(lilacAlbum.coverResId)
